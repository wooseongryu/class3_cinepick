                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                            	<h1 class="h4 text-gray-900 mb-4">극장 수정</h1>
                            </div>
                            <form class="user" action="adminTheaterUpdatePro" method="post">
                            	<input type="hidden" name="theater_idx" value="${theater.theater_idx }">
                            	
                                <div class="form-group row">
									<div class="col-sm-12 mb-6 mb-sm-0">
										<label for="">지역번호</label>
										<input type="text" name="brchNo" placeholder="지역번호입력" value="${theater.brchNo }">
								  	</div>
                                </div>
                                <div class="form-group row">
									<div class="col-sm-12 mb-6 mb-sm-0">
										<label for="">극장명</label>
										<input type="text" name="theater_name" placeholder="극장명입력" value="${theater.theater_name }">
								  	</div>
                                </div>
                                <br>
								<div class="form-group row">
                                    <div class="col-sm-12 mb-6 mb-sm-0">
									  ...
									  <textarea rows="10" name="theater_title" class="form-control form-control-textarea" 
									  	placeholder="극장설명작성" id="floatingTextarea">${theater.theater_title }</textarea>
									</div>
                                </div>
								<br>
								<div class="form-group row">
                                    <div class="col-sm-12 mb-6 mb-sm-0">
									  ...
									  <textarea rows="10" name="theater_address" class="form-control form-control-textarea" 
									  	placeholder="극장주소작성" id="floatingTextarea">${theater.theater_address }</textarea>
									</div>
                                </div>
								<br>
                                ...
                                <div class="form-group row" align="center">
									<div class="col-sm-12 mb-6 mb-sm-0">
		                                <input type="submit" class="btn btn-primary btn-user" onclick="close()" value="수정">&nbsp;
