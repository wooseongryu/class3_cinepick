                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">스토어 등록</h1>
                            </div>
                            <form class="user" action="adminStoreInsertPro" method="post" enctype="multipart/form-data">
                            	<div class="form-group row">
									<div class="col-sm-12 mb-6 mb-sm-0">
										<label for="">카테고리</label>
										<br>
	                                    <select class="form-select" name="store_category" aria-label="Default select example" >
									  		<c:forEach var="storeCategoryList" items="${storeCategoryList }">
												<option value="${storeCategoryList.storeCate_Idx }">${storeCategoryList.storeCate_Subject }</option>
											</c:forEach>
										</select>
								  	</div>
                                </div>
                            	<div class="form-group row">
                                    <div class="col-sm-12 mb-6 mb-sm-0">
                                        ...
                                        <input type="text" name="store_short" class="form-control form-control-user" id="storeShort"
                                            placeholder="상품부연설명입력">
                                    </div>
                                </div>
								<br>
								<div class="form-group row">
                                    <div class="col-sm-12 mb-6 mb-sm-0">
										<label for="">상품명</label>
                                        <input type="text" name="store_title" class="form-control form-control-user" id="storeTitle">
                                    </div>
                                </div>
								<br>
								<div class="form-group row">
                                    <div class="col-sm-12 mb-6 mb-sm-0">
										<label for="">가격</label>
                                        <input type="text" name="store_price" class="form-control form-control-user" id="storePrice">
                                    </div>
                                </div>
								<br>
								<div class="form-group row">
