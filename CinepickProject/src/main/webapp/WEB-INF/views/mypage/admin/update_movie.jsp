                            ...
                            <form class="user" method="post" enctype="multipart/form-data">
								<div class="form-group row">
									...
									<div class="col-sm-5 mb-2 mb-sm-0">
										<label for="">심의등급</label>
										<br>
	                                    <select class="form-select" aria-label="Default select example" >
										  <option selected>심의등급</option>
										  <option value="1">전체관람가</option>
										  <option value="2">12세이상관람가</option>
										  <option value="3">15세이상관람가</option>
										  <option value="4">청소년관람불가</option>
										  <option value="5">제한상영가</option>
										</select>
								  	</div>
								  	<div class="col-sm-5 mb-2 mb-sm-0">
										<label for="">상영일</label>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12 mb-6 mb-sm-0">
									  ...
									  <textarea rows="10" class="form-control form-control-textarea" placeholder="줄거리작성" id="floatingTextarea"></textarea>
									</div>
                                </div>
